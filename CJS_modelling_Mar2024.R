...
BFS = read.csv("merged5.C_23Jan.csv", colClasses = c("character", "character", "factor", "numeric"))
...
BFS.process = process.data(BFS,
                           ...
                           age.var = 2,
                           initial.ages = c(0.5, 1.5, 2.5, 3.5, 4.5))
...
View(BFS.ddl$Phi)
View(BFS.ddl$p)
# when 'time' is interger (time - year = 0), specify 'season' as "S-W"

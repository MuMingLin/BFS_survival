...
# save model table
write.csv(model.table.all, "model.table.all.Jan2025.csv", row.names = TRUE)
...
## Save Jan 2025 ####
# 儲存 Model-Averaged Real Parameter Estimates
write.csv(est.mod.avg.001$estimates, "Model_Avg_Real_Estimates.csv", row.names = FALSE)

# 儲存 Real 參數的 Variance-Covariance Matrix
write.csv(est.mod.avg.001$vcv.real, "Model_Avg_Real_VCV.csv", row.names = FALSE)
...
p.001.uni <- unique(est.mod.avg.001.comb[est.mod.avg.001.comb$parameter=="p",c(2:5,7,9:11,13)])


# save estimates table
write.csv(Phi.001.uni, "Phi.001.uni.Jan2025.csv", row.names = TRUE)
write.csv(p.001.uni, "p.001.uni.Jan2025.csv", row.names = TRUE)
write.csv(est.mod.avg.001.comb, "est.mod.avg.001.comb.Jan2025.csv", row.names = TRUE)
